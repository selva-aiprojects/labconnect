    ...
    <article className="lab-report overflow-hidden border border-slate-200 bg-white text-slate-700 shadow-sm">
      <header className="border-b-[3px] border-[#164b70] px-5 py-5 sm:px-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <div className="flex items-center gap-3"><div className="flex h-10 w-10 shrink-0 items-center justify-center bg-[#164b70] text-white"><ShieldCheck size={22} /></div><div className="min-w-0"><p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#164b70]">Cybe LabConnect</p></div></div>
